...
Notable changes are documented here. This project follows [Semantic Versioning](https://semver.org/) during the public preview, with breaking API changes reserved for minor versions until 1.0.
...
- Added strict x402 v2 Stellar payment requirement guard.
- Added Soroban authorization-to-intent binding.
